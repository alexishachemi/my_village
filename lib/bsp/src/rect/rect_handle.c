...
{
    return (bsp_rect_t){(bsp_v2_t){x, y}, (bsp_v2_t){w, h}};
}
...
int bsp_rect_touching_overlap(bsp_rect_t r1, bsp_rect_t r2)
{
    int x1 = r1.pos.x;
    int y1 = r1.pos.y;
    int w1 = r1.size.x;
...
static bool get_v_centers(bsp_rect_t r1, bsp_rect_t r2,
    bsp_v2_t *c1, bsp_v2_t *c2)
{
...
static bool get_h_centers(bsp_rect_t r1, bsp_rect_t r2,
    bsp_v2_t *c1, bsp_v2_t *c2)
{
    int start1, start2, end1, end2, min_val, max_val, center;
