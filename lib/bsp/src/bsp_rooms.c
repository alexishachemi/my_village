...
static bsp_v2_t get_bounds(int smallest_size, int area, float max_ratio)
{
    int a, b = 0;
...
static bsp_v2_t generate_room_size(bsp_rect_t rect, const bsp_room_settings_t *info)
{
    int r_area = 0;
    int area = 0;
    bsp_v2_t bounds = {0};
...
static void place_room(bsp_t *bsp, bsp_v2_t size)
{
    int available_spacing, spacing_offset = 0;
    bsp_v2_t pos = {0};
    bsp_rect_t rect = bsp->rect;
