...
enum bsp_orient_e {O_NONE = -1, O_VERTICAL = 0, O_HORIZONTAL = 1};
...
bool bsp_init(bsp_t *bsp, bsp_rect_t rect);
bsp_t *bsp_create(bsp_rect_t rect);
bsp_t *bsp_from_parent(const bsp_t *bsp, bsp_rect_t rect);
